    ...
    stages{
     ...
     stage('deploy'){
        ...
        steps{
            ...
            sh "docker run -dit --name=flask-app -p 5000:5000 -e 'MYSQL_HOST=mysql' -e 'MYSQL_USER=admin' -e 'MYSQL_PASSWORD=admin' -e 'MYSQL_DB=mydb' --network my-network ${docker_image}"
        }
